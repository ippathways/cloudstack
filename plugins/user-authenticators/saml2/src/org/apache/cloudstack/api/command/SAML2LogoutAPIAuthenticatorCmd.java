            ...
            if (processedSAMLRequest != null) {
                ...
                if (targetSessionIndex == null) {
                    ...
                    try {
                        ...
                        //resp.flushBuffer();
                        final String postUrl = (token != null) ? token.getSloUrl() : (isInitialRedirect) ? SAMLUtils.getCurrentUrl(req) : ((String[])params.get("postUrl"))[0];
                        s_logger.debug("SAML redirecting Slo request via post to " + postUrl);
